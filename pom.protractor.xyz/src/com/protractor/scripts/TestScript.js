...
var homeLogin = require(process.cwd()
		+ '/src/com/protractor//pages/HomeLoginPage.js')
		var winston = require('winston')
		winston.add(winston.transports.File, {
			filename : './Logs/XYZBankLogFile.log'
		})
		winston.level = 'debug';
		...
		function() {
			...
			it(
					...
					function() {
						...
						homeLogin
						.verifyCustButton(data.HomeLogin.CustomerLogin);
						homeLogin
						.verifyBankButton(data.HomeLogin.BankManagerLogin);
						...
						/*
						 * Manager page lunched with the Options Add
						 * customer,Open accounts,Customer
						 */
						...
						browser.sleep(5000);
						var firstN = addCustomer
						.enterFirstName(data.AddCustomer.FirstName);
						var lastN = addCustomer
						.enterLastName(data.AddCustomer.LastName);
						addCustomer.enterPostCode(data.AddCustomer.PostCode);
						addCustomer.clickaddCustomer();

						/*
						 * Pop message will appear & says Customer added
						 * sucessfully with its autogenerated customer id
						 */

						// addCustomer.verifyAcceptAlert(data.AddCustomer.alertMessage);
						addCustomer
						.verifyAcceptAlert("Customer added successfully with customer id");
						browser.sleep(8000);
						...
						/*
						 * Pop message will appear & says Account created
						 * successfully with autogenerated account Number for
						 * doller
						 */
						openAccount
						.verifyAcceptAlert("Account created successfully with account Number");
						...
						/*
						 * Respective customer will be deleted.it stays in the
						 * customers page
						 */
						customer
						.verifyTitle("Protractor practice website - Banking App")
			...
			it(
					...
					function() {
						...
						account
						.verifyErrorMessage("Transaction Failed. You can not withdraw amount more than the balance.")

						/* TC14: WithDraw Success */
						// account.enterAmount("")
						account
						.enterAmount(data.AddCustomer.AmountWithdrawlValid)
						// account.enterAmount(data.AddCustomer.Amount)
						account.clickWithdrawlButton();
						...
						/*
						 * Verify amount column data should have 1000 traction
						 * type column data should be Debit
						 */
						// listTX.verifyTransectiontable("1000 Debit")
					});

			it('TransectionReset', function() {
				/* Login Page */
				browser.get(data.url);
				browser.manage().window().maximize();
